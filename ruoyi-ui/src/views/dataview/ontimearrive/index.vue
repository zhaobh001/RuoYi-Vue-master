<template>
  <div class="dashboard-editor-container">
    ...
    <el-row :gutter="32">
      ...
      <el-col :xs="32" :sm="32" :lg="12">
        <div class="chart-wrapper">
          <OntimeQtykind-chart :chart-data="ontimeQtykindData"/>
        </div>
      </el-col>
    </el-row>
      ...
      <el-col :xs="32" :sm="32" :lg="32">
        <div class="chart-wrapper">
          ...
          >
            ...
            <el-table-column prop="matName" label="收货数量" width="200"></el-table-column>
            <el-table-column prop="qty" label="收货日期" width="200"></el-table-column>
            <el-table-column prop="ziku" label="入库库房" width="200"></el-table-column>
            <el-table-column prop="collQty" label="收货状态" width="200"></el-table-column>
            <el-table-column prop="requirQty" label="接收人" width="200"></el-table-column>
          </el-table>
          <pagination
            v-show="total>0"
            :total="total"
