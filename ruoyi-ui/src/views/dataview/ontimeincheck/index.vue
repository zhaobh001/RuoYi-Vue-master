  ...
  <div class="dashboard-editor-container">
    ...
    <el-row :gutter="32">
      <el-col :xs="32" :sm="32" :lg="12">
        <div class="chart-wrapper">
          <OntimeCheck-chart :chart-data="inbounddetailData" />
        </div>
      </el-col>

      <el-col :xs="32" :sm="32" :lg="12">
        <div class="chart-wrapper">
          <OntimeQtykindcheck-chart :chart-data="ontimeQtykindData"/>
        </div>
      </el-col>
    </el-row>
      ...
      <el-col :xs="32" :sm="32" :lg="32">
        <div class="chart-wrapper">
          ...
          >
            ...
            <el-table-column prop="matName" label="报检数量" width="200"></el-table-column>
            <el-table-column prop="qty" label="报检日期" width="200"></el-table-column>
            <el-table-column prop="ziku" label="入库库房" width="200"></el-table-column>
            <el-table-column prop="collQty" label="报检状态" width="200"></el-table-column>
            <el-table-column prop="requirQty" label="报检人" width="200"></el-table-column>
          </el-table>
          <pagination
            v-show="total>0"
            :total="total"
...
<script>
  ...
  import OntimeCheckChart from '../../dashboard/OntimeCheckChart'
  import OntimeQtykindcheckChart from '../../dashboard/OntimeQtykindcheckChart'
